...
export const EnhancedCasinoCard: React.FC<CasinoCardProps> = ({
  ...
  const cardClasses = `
    bg-white rounded-xl border-2 transition-all duration-300 hover:shadow-xl hover:-translate-y-1
    ${variant === 'featured' ? 'border-gold-400 shadow-lg ring-2 ring-gold-100' : 'border-gray-200 hover:border-primary-300'}
  ...
  return (
    <div className={cardClasses}>
      {/* Featured Badge */}
      {variant === 'featured' && (
        <div className="absolute -right-8 top-4 bg-gradient-to-r from-gold-400 to-gold-500 text-white px-8 py-1 text-sm font-semibold transform rotate-12 shadow-md">
          Featured
        </div>
      )}
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex space-x-3 mt-auto">
          <a
            ...
            className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold py-3 px-4 rounded-lg text-center transition-colors duration-200"
